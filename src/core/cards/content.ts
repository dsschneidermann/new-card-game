...
export const CARD_DEFS: readonly CardDef[] = [
  ...
  },
  {
    ...
    effectArt: AssetKeys.cardEffectWhirlwind,
...
export const SPELL_DEFS: readonly SpellDef[] = [
  {
    ...
    effectArt: AssetKeys.spellEffectBlizzard,
  ...
  },
  {
    ...
    effectArt: AssetKeys.spellEffectSelfheal,
  ...
  },
  {
    ...
    effectArt: AssetKeys.spellEffectTeleport,
